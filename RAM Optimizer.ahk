...
Gui, Add, StatusBar 
SB_SetParts( 100, 150 )
Gui, Add, Button, h25 w400 gFreeRam vboton, Free up memory
Gui, Show,, RAM Optimizer by elModo7
SetTimer, XGraph_Plot, 500
GoTo, XGraph_Plot
return

FreeRam:
 EmptyMem() ; Empties based on APP PID
 FreeMemory() ; Empties from all processes
return
...
XGraph_Plot:
  CPUL := MemoryLoad()
  GuiControl,,boton, Free up memory [ %CPUL%`% ]
